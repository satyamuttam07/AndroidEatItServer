...
public class FoodList extends AppCompatActivity {
    ...
    private void showAddFoodDialog() {
        ...
        altertDialog.setMessage("Please Fill Complete Information");
    ...
    private void showUpdateFoodDialog(final String key, final Food item) {
        ...
        AlertDialog.Builder altertDialog = new AlertDialog.Builder(FoodList.this);
        altertDialog.setTitle("Edit Food");
        altertDialog.setMessage("Please Fill Complete Information");
        ...
        altertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                    ...
                    Snackbar.make(rootLayout,"Food "+item.getName()+" was Editted",Snackbar.LENGTH_SHORT).show();
